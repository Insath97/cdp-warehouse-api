...
class UpdateVehicleLogRequest extends FormRequest
{
    ...
    {
        return [
            'vehicle_number' => 'sometimes|required|string|max:20',
            'vehicle_type' => 'sometimes|required|string|in:lorry,pickup,van,tractor,other',
            'log_type' => 'sometimes|required|string|in:stock_in,stock_out',
            ...
            // Gate OUT verification uploads
            'exit_license_plate_image' => 'nullable|image|max:4096',
            'exit_vehicle_image' => 'nullable|image|max:4096',
            'exit_document' => 'nullable|file|mimes:pdf,jpg,png,doc,docx|max:10240',
        ];
    }
